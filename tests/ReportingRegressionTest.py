...
exclude = '--include REPORTING --exclude  EXCLUDE  --exclude WIP  --exclude PRODUCTION  --exclude PARTNERS_SEARCH  --exclude MOCK_DATABASE_SETUP  --exclude GEO_HISTORY  --exclude Known_Issue --exclude PRIZM  --exclude CONNEXIONS'
